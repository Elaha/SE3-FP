...
; Aufgabe 1.1 (2.1) (3.1)
; Wir haben uns bei den Aufgaben, für die Datenstruktur der Liste entschieden. 
...
; Aus diesen Gründen, werden wir fortlaufen auch für die nächsten Aufgaben, die Liste als Datenstruktur wählen.
...
; Aufgabe 2.1
; Wahl der Datenstruktur: Liste (Aufgrund der oben genannten Gründe).
...
; Übersetzt einen Char in einen Morsecode.
(define (char->morse x)
 (play-sound (cadr(assoc x morsealphabet)) #f))

; Aufgabe 3.3
; Übersetzt mit Hilfe der oberen Funktion "char->morse" eine Liste aus Chars, 
; in die entsprechenden Morsecode, welche in der Liste gespeichert sind.
